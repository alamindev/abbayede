<template>
  <section class="overflow-hidden relative  pb-14 md:pb-0 pt-8 sm:pt-14"> 
          <figure class="absolute right-0 ">  
              <img class="h-[500px] md:h-[600px] xl:h-[700px] 2xl:h-auto object-cover object-top"  src="~/assets/images/hightlight.png" alt="hightlight.png"/>
          </figure>  
     <div class="w-full  px-4 pt-8 sm:pt-20 md:pt-40 pb-8 sm:pb-20 md:pb-64 xl:pt-72 xl:pb-72">
        ...
        <div class="w-[980px] max-w-full space-y-3 md:space-y-5">
            <div class="pr-12 sm:pr-0">
                <h2 class="text-[32px] inline  leading-[1.2] font-semibold text-brand-red ">Mise en avant avec gravure </h2>
