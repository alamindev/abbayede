<template>
    ...
    <div class="max-w-screen-2xl mx-auto">
        <header class="flex justify-center flex-col gap-3 items-center">
            ...
            <h2 class="text-[32px] md:text-[42px] leading-[1.2] text-white font-lancelot text-center">Plongez au coeur de l’Abbaye</h2>
        </header> 
  ...
  export default {
    ...
    data() {
      return { 
        items: [
          { 
            image: '/images/gallary/gallary-img-1.png'
          } ,
          { 
            image: '/images/gallary/gallary-img-2.png'
          } ,
          { 
            image: '/images/gallary/gallary-img-3.png'
          }, 
          { 
            image: '/images/gallary/gallary-img-5.png'
          }, 
          { 
            image: '/images/gallary/gallary-img-4.png'
          }, 
          { 
            image: '/images/gallary/gallary-img-6.png'
          } ,
          { 
            image: '/images/gallary/gallary-img-7.png'
          }, 
          { 
            image: '/images/gallary/gallary-img-8.png'
          }, 
          { 
            image: '/images/gallary/gallary-img-9.png'
          }, 
          { 
            image: '/images/gallary/gallary-img-10.png'
          }, 
        ]
      }
    }, 
