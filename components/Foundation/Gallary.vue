<template>
    ...
    <div class="max-w-screen-2xl mx-auto">
        <header class="flex justify-center flex-col gap-3 items-center">
            ...
            <h2 class="text-[32px] md:text-[42px] leading-[1.2] text-white font-lancelot text-center">L’atelier</h2>
        </header> 
  ...
  export default {
    ...
    data() {
      return { 
        items: [
          { 
            image: '/images/foundation/img-5.png'
          }, 
          { 
            image: '/images/foundation/img-6.png'
          }, 
          { 
            image: '/images/foundation/img-7.png'
          }, 
          { 
            image: '/images/foundation/img-8.png'
          }, 
          { 
            image: '/images/foundation/img-9.png'
          }, 
          { 
            image: '/images/foundation/img-10.png'
          }, 
